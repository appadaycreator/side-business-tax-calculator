...
const SVC_URL = "https://appadaycreator.com/side-business-tax-calculator/";
const SVC_NAME = "副業税金計算ツール";

test.describe("副業税金計算ツール - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("side-business-tax-calculator");
